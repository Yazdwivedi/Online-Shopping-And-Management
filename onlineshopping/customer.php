  ...
  <div class="modal-dialog">
      ...
      <div class="modal-body">
        ...
        <form class="" method="post">
          ...
          <input class="form-control" type="text" name="landmark" placeholder="<?php echo$ro->landmark;?>">
          <label>City</label>
          ...
          <input class="form-control" type="text" name="pin" placeholder="Pincode" value="<?php echo$ro->pincode;?>">
