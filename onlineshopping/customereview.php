...
if(isset($_POST["rev"])){
	...
	header("Location:customerwrite.php");
	die();
}
?>
<!DOCTYPE html>
...
<div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
  ...
  <div class="jumbotron top">
    <h3 style="margin-left:40%;">Your Purchased Items</h3><br>
    <table style="margin-left:10%;">
	  ...
	  <?php
	  $result=$conn->query("select * from finallist where c_id={$_SESSION["id"]}");
      ...
      <td><?php echo$row->title;?></td>
		...
		<td><?php echo$row->quantity;?></td>
			...
			<td>
			<form method="post">
			<input type="hidden" name="id" value="<?php echo$_SESSION["itemid"];?>"></input>
			<button type="submit" class="btn btn-primary" name="rev">Write Review</button>
